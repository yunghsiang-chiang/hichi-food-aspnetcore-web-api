...
public partial class HochiSystemContext : DbContext
{
    ...
    public virtual DbSet<HCNotes> HCNotes { get; set; }
    ...
    public virtual DbSet<HCommentLibrary> HCommentLibrary { get; set; }
    ...
    public virtual DbSet<HCourseBooking_Exam> HCourseBooking_Exam { get; set; }
    ...
    public virtual DbSet<HDRecordQuestion> HDRecordQuestion { get; set; }

    public virtual DbSet<HDSchedule> HDSchedule { get; set; }

    public virtual DbSet<HDayOffForm> HDayOffForm { get; set; }

    public virtual DbSet<HDharma> HDharma { get; set; }

    public virtual DbSet<HDharmaRecord> HDharmaRecord { get; set; }
    ...
    public virtual DbSet<HExamAssignment> HExamAssignment { get; set; }
    ...
    public virtual DbSet<HExamCandidateNo> HExamCandidateNo { get; set; }
    ...
    public virtual DbSet<HExamSubjectScoreItem> HExamSubjectScoreItem { get; set; }
    ...
    public virtual DbSet<HFeelingsJournalsTag> HFeelingsJournalsTag { get; set; }
    ...
    public virtual DbSet<HMainTeam> HMainTeam { get; set; }

    public virtual DbSet<HMainTeamMembers> HMainTeamMembers { get; set; }

    public virtual DbSet<HMandateStatusOption> HMandateStatusOption { get; set; }
    ...
    public virtual DbSet<HPRLightReceiver> HPRLightReceiver { get; set; }
    ...
    public virtual DbSet<HPracticeReason> HPracticeReason { get; set; }

    public virtual DbSet<HPracticeRecord> HPracticeRecord { get; set; }

    public virtual DbSet<HPracticeRecordAnswer> HPracticeRecordAnswer { get; set; }

    public virtual DbSet<HPracticeRecordReason> HPracticeRecordReason { get; set; }

    public virtual DbSet<HPracticeRecordReply> HPracticeRecordReply { get; set; }
    ...
    public virtual DbSet<HScoreItem> HScoreItem { get; set; }
    ...
    public virtual DbSet<HShoppingCart_Exam> HShoppingCart_Exam { get; set; }
    ...
    public virtual DbSet<HSubQuestion> HSubQuestion { get; set; }
    ...
    public virtual DbSet<HTodo> HTodo { get; set; }

    public virtual DbSet<HTodoAssignee> HTodoAssignee { get; set; }

    public virtual DbSet<HTodoAttachment> HTodoAttachment { get; set; }

    public virtual DbSet<HTodoComment> HTodoComment { get; set; }
    ...
    public virtual DbSet<HTwentyOneLights> HTwentyOneLights { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HAreaFun__3214EC079FB56097");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HAreaMon__3214EC0770226A47");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HAttenda__3214EC073837B9A0");
        ...
        modelBuilder.Entity<HCNotes>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.HCourseName).HasMaxLength(100);
            entity.Property(e => e.HCreateTime).HasColumnType("datetime");
            entity.Property(e => e.HDirections).HasMaxLength(300);
        });
        ...
        modelBuilder.Entity<HCommentLibrary>(entity =>
        {
            entity.HasKey(e => e.HID).HasName("PK__HComment__C75515272D54730E");

            entity.Property(e => e.HCommentType).HasComment("1:優點、2:須改善");
            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.HExamSubjectScoreItem).WithMany(p => p.HCommentLibrary)
                .HasForeignKey(d => d.HExamSubjectScoreItemID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_HCL_Subject");
        });
        ...
        modelBuilder.Entity<HCourse>(entity =>
        {
            ...
            entity.Property(e => e.HOPlace).HasMaxLength(50);
        ...
        modelBuilder.Entity<HCourseBooking_Exam>(entity =>
        {
            entity.HasKey(e => e.HID);

            entity.Property(e => e.HCreate).HasMaxLength(100);
            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HExamContentID).HasComment("檢覈內容名稱(關聯HExamContent.HID)");
        ...
        modelBuilder.Entity<HDRecordQuestion>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HCreateDT)
                .HasComment("建立日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HDharmaRecordID).HasComment("法築基紀錄HID");
            ...
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HQuestionGroup)
                .HasMaxLength(20)
                .HasComment("題號(題目群組)");
            entity.Property(e => e.HQuestionInfo).HasMaxLength(255);
            entity.Property(e => e.HQuestionItem)
                .HasMaxLength(255)
                .HasComment("題目選項");
            entity.Property(e => e.HQuestionName)
                .HasMaxLength(255)
                .HasComment("題目");
            entity.Property(e => e.HQuestionType).HasComment("題目類型(1=單選題、2=多選題、3=問答題)");
            entity.Property(e => e.HRelatedQGroup).HasComment("關聯下一題號");
            entity.Property(e => e.HSort).HasComment("題目順序");
            entity.Property(e => e.HStatus).HasComment("狀態");
            entity.Property(e => e.HSubQuestionID).HasComment("關聯題目模組HID");
        });

        modelBuilder.Entity<HDSchedule>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.HModifytime).HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<HDharmaRecord>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.HCompletedTimes).HasComment("須完成人數/次數");
            entity.Property(e => e.HCreate)
                .HasMaxLength(50)
                .HasComment("建立者");
            entity.Property(e => e.HCreateDT)
                .HasComment("建立日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HDRecordName)
                .HasMaxLength(250)
                .HasComment("紀錄表名稱");
            entity.Property(e => e.HDharmaID).HasComment("受傳法HID");
            entity.Property(e => e.HFileMusic).HasComment("檔案(mp3) 多個用json格式存");
            entity.Property(e => e.HFilePDF).HasComment("檔案(PDF) 多個用json格式存");
            entity.Property(e => e.HID).ValueGeneratedOnAdd();
            entity.Property(e => e.HIntroduction).HasComment("簡述介紹");
            entity.Property(e => e.HLink).HasComment("法影連結(json格式，名稱+超連結)");
            entity.Property(e => e.HModify)
                .HasMaxLength(50)
                .HasComment("修改者");
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HNoticeNum)
                .HasMaxLength(250)
                .HasComment("通知的檢核點(人數/次數)");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });
        ...
        modelBuilder.Entity<HExamAssignment>(entity =>
        {
            entity.HasKey(e => e.HID);

            entity.Property(e => e.HAssignTime).HasMaxLength(50);
            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HExamContentID).HasComment("檢覈內容名稱(關聯HExamContent.HID)");
            entity.Property(e => e.HModify).HasMaxLength(50);
        ...
        modelBuilder.Entity<HExamCandidateNo>(entity =>
        {
            entity.HasKey(e => e.HID).HasName("PK__HExamCan__C7551527292953B1");

            entity.Property(e => e.HCourseID).HasMaxLength(50);
            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.HExamNo).HasMaxLength(50);
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasColumnType("datetime");
            entity.Property(e => e.HStatus).HasDefaultValue(1);
        });
        ...
        modelBuilder.Entity<HExamClassRoom>(entity =>
        {
            ...
            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HExamClassRoomName)
                .HasMaxLength(150)
                .HasComment("教室");
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
        ...
        modelBuilder.Entity<HExamContent>(entity =>
        {
            ...
            entity.Property(e => e.HLeadingExamID).HasComment("對應的前導檢覈名稱(多選)");
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
            entity.Property(e => e.HRemark)
                .HasMaxLength(50)
        ...
        modelBuilder.Entity<HExamContentDetail>(entity =>
        {
            ...
            entity.Property(e => e.HExamClassRoomName).HasMaxLength(100);
        ...
        modelBuilder.Entity<HExamInterviewer>(entity =>
        {
            ...
            entity.Property(e => e.HCreate).HasMaxLength(100);
            entity.Property(e => e.HCreateDT).HasColumnType("datetime");
            entity.Property(e => e.HExamClassRoomID).HasComment("教室HID");
            entity.Property(e => e.HExamContentID).HasComment("檢覈內容HID");
            entity.Property(e => e.HExamSubjectID).HasComment("考試科目HID");
            entity.Property(e => e.HInterviewer1)
                .HasMaxLength(100)
                .HasComment("主考官1");
            entity.Property(e => e.HInterviewer2)
                .HasMaxLength(100)
                .HasComment("主考官2");
            entity.Property(e => e.HInterviewer3)
                .HasMaxLength(100)
                .HasComment("主考官3");
            entity.Property(e => e.HModify).HasMaxLength(100);
            entity.Property(e => e.HModifyDT).HasColumnType("datetime");
            entity.Property(e => e.HPlaceID).HasComment("考場HID");
        });
        ...
        modelBuilder.Entity<HExamScore>(entity =>
        {
            ...
            entity.Property(e => e.HCreate)
                ...
                .HasComment("建立者");
            entity.Property(e => e.HCreateDT).HasColumnType("datetime");
            entity.Property(e => e.HEvaluationType).HasComment("1:非教練檢覈/2:教練檢覈");
            entity.Property(e => e.HExamClassRoomID).HasComment("教室名稱(dbo.HExamClassRoom.HID)");
            ...
            entity.Property(e => e.HGoodComment).HasComment("優點項目");
            entity.Property(e => e.HImproveComment).HasComment("改善項目");
            entity.Property(e => e.HMemberID).HasComment("考生HID");
            entity.Property(e => e.HModify).HasMaxLength(10);
            entity.Property(e => e.HModifyDT).HasColumnType("datetime");
            entity.Property(e => e.HPassedDate).HasComment("通過日期(依發布成績的日期)");
            entity.Property(e => e.HPlaceID).HasComment("考場名稱(dbo.HPlace.HID)");
            entity.Property(e => e.HPublishedStatus).HasComment("發布成績與否(1:已發布)");
        ...
        modelBuilder.Entity<HExamSubjectScoreItem>(entity =>
        {
            entity.HasKey(e => e.HID).HasName("PK__HExamSub__C755152736108008");

            entity.HasIndex(e => new { e.HExamSubjectID, e.HScoreItemID }, "UQ_HESSI").IsUnique();
            ...
            entity.HasOne(d => d.HExamSubject).WithMany(p => p.HExamSubjectScoreItem)
                .HasForeignKey(d => d.HExamSubjectID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_HESSI_Subject");

            entity.HasOne(d => d.HScoreItem).WithMany(p => p.HExamSubjectScoreItem)
                .HasForeignKey(d => d.HScoreItemID)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_HESSI_ScoreItem");
        });
        ...
        modelBuilder.Entity<HFeelingsJournalsTag>(entity =>
        {
            entity.HasKey(e => e.HID).HasName("PK__HFeeling__C75515274274C602");

            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
            entity.Property(e => e.HStatus).HasDefaultValue(1);
            entity.Property(e => e.HTagContent).HasMaxLength(1000);
            entity.Property(e => e.HTaggerMemberID).HasComment("建立者");
        });
        ...
        modelBuilder.Entity<HMainTeam>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.HAreaID)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasComment("區屬 HArea.HID");
            entity.Property(e => e.HCreate)
                .HasMaxLength(20)
                .HasComment("建立者");
            entity.Property(e => e.HCreateDT)
                .HasComment("建立日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HDate).HasComment("定位日期");
            entity.Property(e => e.HID)
                .ValueGeneratedOnAdd()
                .HasComment("流水號");
            entity.Property(e => e.HLAreaCode)
                .HasMaxLength(50)
                .HasComment("大區代碼(簡稱+流水號)");
            entity.Property(e => e.HLAreaID).HasComment("HLArea.HID");
            entity.Property(e => e.HMainTeamCode)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasComment("真光團代碼(大區-傳光玉成單位-真光團)");
            entity.Property(e => e.HMentorID).HasComment("導師 (HMember.HID)");
            entity.Property(e => e.HModify)
                .HasMaxLength(20)
                .HasComment("修改者");
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HStatus).HasComment("狀態 (1=啟用、0=停用)");
            entity.Property(e => e.HTeamID)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasComment("光團HID (格式: HID,1 或 HID,2；1=母光團(HMTeam)、2=子光團(HCTeam))");
            entity.Property(e => e.HTeamLeaderID).HasComment("團長 (HMember.HID)");
        });

        modelBuilder.Entity<HMainTeamMembers>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HID)
                .ValueGeneratedOnAdd()
                .HasComment("流水號");
            entity.Property(e => e.HJoinYear)
                .HasMaxLength(20)
                .HasComment("加入年度");
            entity.Property(e => e.HLearningGroup).HasComment("學習族群(1=Main、2=PartTime、3=NewFriend)");
            entity.Property(e => e.HMainTeamID).HasComment("真光團流水號(HMainTeam.HID)");
            entity.Property(e => e.HMemberID).HasComment("學員HID (HMember.HID)");
            entity.Property(e => e.HModify)
                .HasMaxLength(20)
                .HasComment("修改者");
        ...
        modelBuilder.Entity<HMandateStatusOption>(entity =>
        {
            entity.HasKey(e => e.HId).HasName("PK__HMandate__C7551547D6CAD684");

            entity.HasIndex(e => e.HStatus, "UQ__HMandate__94FD449D81826F64").IsUnique();

            entity.Property(e => e.HIsActive).HasDefaultValue(true);
            entity.Property(e => e.HStatus).HasMaxLength(50);
        });
        ...
        modelBuilder.Entity<HPNotes>(entity =>
        {
            entity.HasNoKey();
        ...
        modelBuilder.Entity<HPRLightReceiver>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeRecordID).HasComment("築基紀錄ID");
            entity.Property(e => e.HReceiverLight)
                .HasMaxLength(100)
                .HasComment("接光人光系");
            entity.Property(e => e.HReceiverName)
                .HasMaxLength(150)
                .HasComment("接光人姓名");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });
        ...
        modelBuilder.Entity<HPlace>(entity =>
        {
            ...
            entity.Property(e => e.HAddress).HasComment("地址");
            entity.Property(e => e.HAreaID)
                .HasMaxLength(50)
                .HasComment("區屬");
            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HID).ValueGeneratedOnAdd();
            entity.Property(e => e.HLArea)
                .HasMaxLength(30)
                .HasComment("大區");
            entity.Property(e => e.HManager)
                .HasMaxLength(50)
                .HasComment("負責人");
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
            entity.Property(e => e.HPlaceLevel)
                .HasMaxLength(20)
                .HasComment("地點層級");
            entity.Property(e => e.HPlaceName)
                .HasMaxLength(255)
                .HasComment("地點名稱");
        });
        ...
        modelBuilder.Entity<HPlaceList>(entity =>
        {
            ...
            entity.Property(e => e.HManager).HasMaxLength(50);
            entity.Property(e => e.HPlaceLevel).HasMaxLength(20);
            entity.Property(e => e.HPlaceName).HasMaxLength(255);
            entity.Property(e => e.HUserName).HasMaxLength(537);
        });
        ...
        modelBuilder.Entity<HPracticeReason>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeReasonName)
                .HasMaxLength(200)
                .HasComment("築基原因");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });

        modelBuilder.Entity<HPracticeRecord>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.HAvgTime)
                .HasMaxLength(100)
                .HasComment("平均傳光時間");
            entity.Property(e => e.HCreate)
                .HasMaxLength(50)
            ...
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeDate).HasComment("傳光日期");
            entity.Property(e => e.HPracticeNum).HasComment("傳光人數/次數");
            entity.Property(e => e.HPracticeRecordReasonID).HasComment("築基原因ID (HPracticeRecordReason.HID)");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });

        modelBuilder.Entity<HPracticeRecordAnswer>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HID)
                .ValueGeneratedOnAdd()
                .HasComment("流水號");
            entity.Property(e => e.HMemberID).HasComment("學員ID(填寫者)");
            entity.Property(e => e.HModify)
                .HasMaxLength(20)
                .HasComment("修改者");
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeRecordID).HasComment("關聯哪一張築基紀錄");
            entity.Property(e => e.HQuestion).HasComment("題目");
            entity.Property(e => e.HQuestionAnswer).HasComment("作答的題目答案(數值)");
            entity.Property(e => e.HQuestionGroup).HasComment("題號(題目群組)");
            entity.Property(e => e.HQuestionOption).HasComment("作答的題目選項(文字)");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });

        modelBuilder.Entity<HPracticeRecordReason>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HCreateDT)
                .HasComment("建立日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HEndDate).HasComment("結束築基日期");
            entity.Property(e => e.HID)
                .ValueGeneratedOnAdd()
                .HasComment("流水號");
            entity.Property(e => e.HMemberID).HasComment("學員ID(填寫者)");
            ...
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeReasonID)
                .HasMaxLength(20)
                .HasComment("築基原因(HPracticeReason.HID)");
            entity.Property(e => e.HStartDate).HasComment("開始築基日期");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });

        modelBuilder.Entity<HPracticeRecordReply>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HCreateDT)
                .HasComment("建立日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HFeedback).HasComment("回饋內容");
            entity.Property(e => e.HID)
                .ValueGeneratedOnAdd()
                .HasComment("流水號");
            entity.Property(e => e.HMemberID).HasComment("回覆者HID");
            entity.Property(e => e.HModify)
                .HasMaxLength(50)
                .HasComment("修改者");
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HPracticeRecordID).HasComment("築基紀錄HID");
            entity.Property(e => e.HStatus).HasComment("狀態");
        });
        ...
        modelBuilder.Entity<HSCGRMsg>(entity =>
        {
            ...
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
            entity.Property(e => e.HNotifyMentor).HasComment("是否通知導師及帶領導師");
        ...
        modelBuilder.Entity<HScoreItem>(entity =>
        {
            entity.HasKey(e => e.HID).HasName("PK__HScoreIt__C75515279E0E3E27");

            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.HItemName).HasMaxLength(100);
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasColumnType("datetime");
            entity.Property(e => e.HStatus).HasDefaultValue(1);
        });
        ...
        modelBuilder.Entity<HShoppingCart_Exam>(entity =>
        {
            entity.HasKey(e => e.HID);
        ...
        modelBuilder.Entity<HSubQuestion>(entity =>
        {
            entity.HasNoKey();
            ...
            entity.Property(e => e.HCreateDT)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.HID).ValueGeneratedOnAdd();
            entity.Property(e => e.HLeftLabel).HasMaxLength(100);
            entity.Property(e => e.HModify)
                .HasMaxLength(20)
                .HasComment("修改者");
            entity.Property(e => e.HModifyDT)
                .HasComment("修改日期")
                .HasColumnType("datetime");
            entity.Property(e => e.HRightLabel).HasMaxLength(100);
            entity.Property(e => e.HSort).HasComment("排序");
            entity.Property(e => e.HStatus).HasComment("狀態");
            entity.Property(e => e.HSubQuestionInfo).HasMaxLength(255);
            entity.Property(e => e.HSubQuestionItem)
                .HasMaxLength(255)
                .HasComment("題目選項");
            entity.Property(e => e.HSubQuestionItemInfo).HasMaxLength(255);
            entity.Property(e => e.HSubQuestionName)
                .HasMaxLength(255)
                .HasComment("題目模組名稱");
            entity.Property(e => e.HSubQuestionType).HasComment("題目類型(1=單選題、2=多選題、3=問答題、4=分數量表、5=滑桿式)");
        });
        ...
        modelBuilder.Entity<HTodo>(entity =>
        {
            entity.HasKey(e => e.TodoId).HasName("PK__HTodo__95862552487948DE");
        ...
        modelBuilder.Entity<HTodoAssignee>(entity =>
        {
            entity.HasKey(e => e.TodoAssigneeId).HasName("PK__HTodoAss__5D5351B7FE0202E7");
        ...
        modelBuilder.Entity<HTodoAttachment>(entity =>
        {
            entity.HasKey(e => e.AttachmentId).HasName("PK__HTodoAtt__442C64BE41756EB1");
        ...
        modelBuilder.Entity<HTodoComment>(entity =>
        {
            entity.HasKey(e => e.CommentId).HasName("PK__HTodoCom__C3B4DFCAA6B7380C");
        ...
        modelBuilder.Entity<HTwentyOneLights>(entity =>
        {
            entity.HasKey(e => e.HID);

            entity.Property(e => e.HCreate).HasMaxLength(50);
            entity.Property(e => e.HCreateDT).HasMaxLength(50);
            entity.Property(e => e.HLightName).HasMaxLength(100);
            entity.Property(e => e.HModify).HasMaxLength(50);
            entity.Property(e => e.HModifyDT).HasMaxLength(50);
        });
