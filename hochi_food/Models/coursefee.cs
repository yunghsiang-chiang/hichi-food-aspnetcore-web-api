...
public partial class coursefee
{
    ...
    public string cf_cdate { get; set; } = null!;

    public string cf_cname { get; set; } = null!;

    public string cf_udate { get; set; } = null!;

    public string cf_uname { get; set; } = null!;
}
